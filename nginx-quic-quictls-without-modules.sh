...
# Run: bash ngx.sh
# Dependencies: mercurial git checkinstall autoconf automake cmake ninja-build libtool wget unzip patch libpcre3-dev zlib1g-dev libatomic-ops-dev libpcre2-dev libtalloc2 libtalloc-dev
#
# Patches: 
#  - 
...
--with-cc-opt="-g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -DTCP_FASTOPEN=23 -fPIC" \
